...
class HelpIconPackager:
    ...
    def add_help(cls, *, main, widget: QWidget, on_help) -> QWidget:
        return IconPackager.add_svg_icon(
            main=main,
            widget=widget,
            on_click=on_help,
            icon_path=HelpIconPackager.HELP_ICON,
        )
    ...
    def make_clickable_label(self, parent, on_help=None) -> ClickableLabel:
        return IconPackager.make_clickable_label(
            parent, on_help, HelpIconPackager.HELP_ICON
        )
...
class HelpHeaderView(QHeaderView):
    def __init__(self, parent=None, *, on_help):
        ...
        self.help_icon_label = HelpIconPackager.make_clickable_label(
            self if parent is None else parent, on_help=on_help
        )

...
class StyleUtility:
    ...
    def get_not_editable_color(cls) -> str:
        color = (
            StyleUtility.NOT_EDITABLE_DARK
            if darkdetect.isDark()
            else StyleUtility.NOT_EDITABLE
        )
        return color
    ...
    def get_not_editable_color_2(cls) -> str:
        color = (
            StyleUtility.NOT_EDITABLE_DARK_2
            if darkdetect.isDark()
            else StyleUtility.NOT_EDITABLE_2
        )
        return color
    ...
    def _set_editable_background(cls, widget) -> None:
        ...
        if inst:
            ...
            print(
                f"Unknown widget type: {widget.__class__.__name__}. Cannot determine editability for style."
            )
        #

...
class RunInfo:
    ...
    def populate(self, path: CsvPath) -> None:
        ...
        self.info["return_mode"] = path.return_mode
        self.info["unmatched_mode"] = path.unmatched_mode
        self.info["files_mode"] = path.files_mode
        self.info["transfer_mode"] = path.transfer_mode
        self.info["collect_when_not_matched"] = (
            path.collect_when_not_matched
        )  # return mode

        self.info["explain"] = path.explain  # explain mode
        self.info["will_run"] = path.will_run  # run mode
        self.info["data_from_preceding"] = path.data_from_preceding  # source mode

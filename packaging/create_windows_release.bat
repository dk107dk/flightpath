...
C:\"Program Files (x86)"\"Windows Kits"\10\bin\10.0.26100.0\arm64\makeappx pack /d C:\dev\flightpath\packaging\dist\FlightPathData /p C:\dev\flightpath\packaging\dist\FlightPathData-arm64.msix

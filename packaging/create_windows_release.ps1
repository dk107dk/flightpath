...
#
# only this first step is really needed for an app submission because Microsoft 
# will sign it with their root CA. however, it costs virtually nothing to create
# both installers at the same time
#
...
#
# sign the test exe created by the batch script above. 
# this step isn't needed for an app submission because Microsoft will sign it with their root CA
#
C:\"Program Files (x86)"\"Windows Kits"\10\bin\10.0.26100.0\arm64\signtool sign /f c:\dev\flightpath\packaging\assets\FlightPathCert.pfx /p hangzhou /fd SHA256 C:\dev\flightpath\packaging\dist\FlightPathData-test-arm64.msix

#
# create the unsigned prod exe
#
